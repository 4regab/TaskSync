...
- Backward compatibility: legacy `tasksync.askUserVerbosePayload` is still read as fallback
- Updated webview settings modal, remote settings wiring, and tests for Auto Append behavior
