...
- Execute `python -c "import sys; print('Enter task (Ctrl+D to submit):'); sys.stdin.read()"` using run_in_terminal tool
...
- Universal: `python -c "import sys; print('Enter task (Ctrl+D to submit):'); task=sys.stdin.read()"` using run_in_terminal tool
...
2. **Immediate Task Request**: Execute universal command - PRIMARY DIRECTIVE
   - Universal: `python -c "import sys; print('Enter task (Ctrl+D to submit):'); task=sys.stdin.read()"`
...
```
# Universal
python -c "import sys; print('Enter task (Ctrl+D to submit):'); task=sys.stdin.read()"
```
...
Terminal: python -c "import sys; print('Enter task (Ctrl+D to submit):'); task=sys.stdin.read()"
